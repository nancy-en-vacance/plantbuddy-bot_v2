...
async def _analyze_latest_photo(user_id: int, plant_id: int, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    instructions = (
        ...
        "5) Если нужно уточнить:\n"
        "- What additional photos or information would help improve confidence.\n\n"
        "---\n\n"
        "IMPORTANT:\n"
